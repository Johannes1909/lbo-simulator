...
export const en = {
  ...
  saved: {
    title: 'Saved',
    namePrompt: 'Name this case',
    save: 'Save',
    saveAsNew: 'Save as new',
    unsavedChanges: 'Unsaved changes',
    emptyState: 'Saved cases will appear here — use Save on the calculator to create the first one.',
    columnName: 'Name',
    columnUpdated: 'Updated',
    columnIrr: 'IRR',
    columnMultiple: 'Multiple',
    columnLeverage: 'Entry leverage',
    open: 'Open',
    rename: 'Rename',
    duplicate: 'Duplicate',
    delete: 'Delete',
    deleteConfirm: 'Delete this saved case? This can\'t be undone.',
    copyLink: 'Copy link',
    sortByName: 'Name',
    sortByDate: 'Date',
    ...
    importResult: (added: number, skipped: number) =>
      `Imported ${added} case${added === 1 ? '' : 's'}${skipped > 0 ? `, skipped ${skipped} already present` : ''}.`,
  },
  nav: {
    brand: 'LBO Simulator',
    menuToggle: 'Menu',
  ...
  presets: {
    label: 'Preset',
    confirmOverwrite: 'You have unsaved changes to the current case. Switching presets will discard them. Continue?',
  },
  mode: {
